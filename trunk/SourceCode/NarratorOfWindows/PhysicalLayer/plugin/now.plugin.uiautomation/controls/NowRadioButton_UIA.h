#ifndef _NOW_RADIO_BUTTON_UIA_H_
#define _NOW_RADIO_BUTTON_UIA_H_

#include "NowDefine.h"
#include "INowControl.h"
#include "NowControl_UIA.h"

class NowRadioButton_UIA : public NowControl_UIA
{
public:
	NowRadioButton_UIA(string strSignature, string strControlType);

	~NowRadioButton_UIA(void);
