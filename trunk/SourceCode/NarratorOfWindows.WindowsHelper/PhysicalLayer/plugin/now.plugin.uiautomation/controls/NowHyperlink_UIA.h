#ifndef _NOW_HYPERLINK_UIA_H_
#define _NOW_HYPERLINK_UIA_H_

#include "NowDefine.h"
#include "INowControl.h"
#include "NowControl_UIA.h"

class NowHyperlink_UIA : public NowControl_UIA
{
public:
	NowHyperlink_UIA(string strSignature, string strControlType);

	~NowHyperlink_UIA(void);
