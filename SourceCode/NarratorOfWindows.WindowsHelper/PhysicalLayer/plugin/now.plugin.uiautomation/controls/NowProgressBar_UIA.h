#ifndef _NOW_PROGRESS_BAR_UIA_H_
#define _NOW_PROGRESS_BAR_UIA_H_

#include "NowDefine.h"
#include "INowControl.h"
#include "NowControl_UIA.h"

class NowProgressBar_UIA : public NowControl_UIA
{
public:
	NowProgressBar_UIA(string strSignature, string strControlType);

	~NowProgressBar_UIA(void);
