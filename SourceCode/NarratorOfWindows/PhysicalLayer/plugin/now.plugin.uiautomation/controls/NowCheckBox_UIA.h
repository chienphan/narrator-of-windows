#ifndef _NOW_CHECK_BOX_UIA_H_
#define _NOW_CHECK_BOX_UIA_H_

#include "NowDefine.h"
#include "INowControl.h"
#include "NowControl_UIA.h"

class NowCheckBox_UIA : public NowControl_UIA
{
public:
	NowCheckBox_UIA(string strSignature, string strControlType);

	~NowCheckBox_UIA(void);
